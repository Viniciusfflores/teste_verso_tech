...
void main() {
  ...
  testWidgets('Home: mostra loading quando isLoading = true', (tester) async {
    final store = FakePokemonStore()..setLoading(true);
  ...
  testWidgets('Home: mostra erro quando errorMessage != null', (tester) async {
  ...
  testWidgets('Home: mostra grid quando tem pokemons', (tester) async {
    final store = FakePokemonStore()
      ..setLoading(false)
      ..setError(null)
      ..setPokemons([bulbasaur(), pikachu()]);
    GetIt.I.registerSingleton<PokemonStore>(store);
